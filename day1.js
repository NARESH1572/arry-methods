// lets take a array find the length of an array.
var arr=[1,2,3,"naresh",true,["vishal","rahul","ragu"],{name:"sai", age:20}]
console.log(arr.length) // output: 7

// How do you add an element to the end of an array?
arr.push(undefined)
console.log(arr) // output: [1,2,3,'naresh',true,['vishal,'rahul','ragu'],{ name: 'sai', age: 20 },undefined ]

// How do you remove the last element from an array?
arr.pop()
console.log(arr) // output: [1,2,3,'naresh',true,['vishal','rahul','ragu'],{ name: 'sai', age: 20 }]

// How do you add an element to the beginning of an array?
arr.unshift("vamsi")
console.log(arr) // output: ["shiva" 1,2,3,'naresh',true,['vishal','rahul','ragu],{ name: 'sai', age: 20}]

// How can you remove the first element from an array?
arr.shift()
console.log(arr); // OUTPUT:- [2,3,'naresh',true,[ 'vishal', 'rahul', 'ragu' ],{ name: 'sai', age: 20 }]
  
// How do you reverse the elements in an array?
arr.reverse();
console.log(arr); // OUTPUT: [{ name: 'sai', age: 20 },[ 'vishal', 'rahul', 'ragu' ],true,'naresh',3,2,1]
  
// How can you find the index of a specific value in an array?
console.log(arr.indexOf("naresh")) // OUTPUT: 3

// How can you check if a certain value exists in an array?
console.log(arr.includes('naresh')); // OUTPUT: true

// How can you sort the elements of an array in ascending order?
console.log(arr.sort()) // OUTPUT: [1,2,3,{ name: 'sai', age: 20 },[ 'vishal', 'rahul', 'ragu' ],'naresh',true]

// How can you convert an array to a string using commas as separators?
console.log(arr.join(",")) //OUTPUT: 1,2,3,naresh,true,vishal,rahul,ragu,[object Object]

// Write a code snippet that adds an element to the end of an array, then removes the first element.
arr=[1,5,9,"ragu","vishal"]
arr.push("shiva", "ravi")
arr.shift()
console.log(arr); //OUTPUT: [ 5, 9, 'ragu', 'vishal', 'shiva', 'ravi' ]

// How can you reverse an array and then join the elements into a string?
a=["n","a","r","e","s","h"]
console.log(a.reverse().join("")); // OUTPUT:hseran

// Write a code that first sorts an array in ascending order, then removes the last element.
var b=[5,33,87,"mani","chintu",true,undefined]
b.sort()
b.pop()
console.log(b); // OUTPUT: [ 33, 5, 87, 'Mani', 'chintu', true ]

// How do you add two elements at the beginning of an array, then remove the first element and find the length of the array?
var b=[5,33,87,"Mani","rakesh",true,undefined]
b.unshift("vishnu","rahul")
b.shift()
console.log(b.length); // OUTPUT: 8

// How do you combine two arrays, sort the combined array, and then remove the last element?
arr1=[1,2,3,"naresh","rahul"]
arr2=["mani","prabhu"]
arr = arr1.concat(arr2)
arr.sort()
arr.pop()
console.log(arr); // OUTPUT: [ 1, 2, 3, 'mani', 'rahul', 'prabhu' ]
